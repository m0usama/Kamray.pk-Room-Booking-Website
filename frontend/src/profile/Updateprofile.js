      ...
      <div className="container rounded bg-white mt-5 mb-5">
          <div className="row">
              ...
              <div className="col-md-4">
                  <div className="p-3 py-5">
                      <div className="d-flex justify-content-between align-items-center experience"><span>Edit Profile</span><span className="border px-3 p-1 add-experience"><i className="fa fa-plus"></i>&nbsp;Update Profile</span></div><br />
